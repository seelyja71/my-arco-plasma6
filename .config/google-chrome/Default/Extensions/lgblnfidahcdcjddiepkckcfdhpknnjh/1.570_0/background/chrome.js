...
function registerToAllEvents() {
    try {
        ...
        chrome.runtime.onMessageExternal.addListener(function (request, sender, sendResponse) {
            ...
            if (request?.type === stndz.messages.openSettingsPage) {
                openTabWithUrl('/index.html#/settings/main')
            }
        });
...
function executeFileOnTab(tabId, file, allFrames = true) {
