...
stndz.resources = {
    ...
    notifications: 'https://new-prod.standsapp.org/user/notifications/',
};
...
var $st = new function() {
    ...
    function internalSetUserData(data, callback) {
        ...
        if (userData.settings) {
            ...
            stndz.settings.guidedSetup = userData.settings.guidedSetup != null ? userData.settings.guidedSetup : stndz.settings.guidedSetup;
            stndz.settings.donationCard = userData.settings.donationCard != null ? userData.settings.donationCard : stndz.settings.donationCard;
